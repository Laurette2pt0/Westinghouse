...
def afficher_canaux():
    ...
    dpg.draw_image(texture_canaux, (xc, yc), (xcf, ycf), parent="drawlist_principal")
    # print(survol_canaux)
    if survol_canaux:
...
def on_mouse_click(sender, app_data):
    global point1_temp, cercles, segments, view_x, view_y, temp_cx, temp_cy, temp_x1, temp_y1, temp_x2, temp_y2, obj,reference_value, ptit_cercle
    if not dpg.is_item_hovered("drawlist_principal"):
        return
    if img_originale_corrigee is None :
        dpg.configure_item("statut", color=(255, 0, 0))
