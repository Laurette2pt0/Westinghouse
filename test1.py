...
def on_mouse_click(sender, app_data):
    ...
    if app_data == 0:
        ...
        # Dessin d'un segment (rapide - sans popup)
...
def clear_segments():
    global segments, point1_temp, ratio_px_mm, segment_etalon_idx, reference_idx, reference_type, reference_value, reference_nom, ptit_sgmt
    segments = []
    point1_temp = None
    ptit_sgmt = 0
    if reference_type == "segment":
