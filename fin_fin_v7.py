#version 1 : présenter à la reu du 10/06
#v2 : plus la calib ni json (en commentaire)
...
#v7 : On voit nul part les rapports, px ou distance valeur blabla aled ca finit quand ?
#MODIFIE le status la on voit encore les px et sur le truc pour changer la ref aussi
